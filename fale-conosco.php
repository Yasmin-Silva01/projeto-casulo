...
<body>
  ...
  <main>
        <article class="">
            <h2>Fale Conosco</h2>
            <p>Entre em contato com o Casulo pra Rua. Caso queira mais informações do nosso trabalho ou tem alguma dúvida, preencha o cadastro abaixo que entraremos em contato.</p>
