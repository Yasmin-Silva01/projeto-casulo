...
<body>
  ...
  <main>
      <article>
          <h1>Casulos pelo Brasil</h1>
          <p class="casulos">
              Os casulos já chegaram em outras cidades <br>
              pelo Brasil. Replique essa ideia na sua cidade.
          </p>

         <a href="https://instagram.com/casuloprarua.curitiba?utm_medium=copy_link"><img class="casulo-curitiba1" src="imagens/curitiba casulo.png" alt="logo casulo-curitiba"></a>
         ...
         <a href="https://instagram.com/redenobem?utm_medium=copy_link"><img class="nobem" src="imagens/no bem logo cópia.png" alt="logo nobem"></a>
         ...
         <hr>
          ...
          <a href="https://instagram.com/casuloprarua.brasilia?utm_medium=copy_link"><img class="casulo-brasilia1" src="imagens/brasilia.png" alt="logo casulo-brasilia"></a>

          <span class="brasilia">
              Brasília / Distrito Federal
         </span>

         <img class="brasilia2" src="imagens/brasilia1.png" alt="Mulher com o saco de dormir (casulo)">

         <img class="brasilia3" src="imagens/brasilia2.png" alt="Uma pessoa dormindo no saco de dormir (casulo)">
      </article>
  </main>
